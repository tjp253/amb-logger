...
import uk.ac.nottingham.eaxtp1.CradleRideLogger.Widgets.EditTextDefault;
...
// baby was on board, whether emergency driving was used, and the reason for transfer.
    ...
    List<String> skipModes; // modes with which to skip the manufacturer & engine options
...
// for ambulance & trolley options - potentially saving time.
        ...
        if (startOfRecording) { // Ask for transport-start data
            ...
            skipModes = Arrays.asList(mode_heli, mode_plane);
