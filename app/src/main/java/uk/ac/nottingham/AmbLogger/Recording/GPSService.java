...
import static uk.ac.nottingham.AmbLogger.MainActivity.gpsBool;
import static uk.ac.nottingham.AmbLogger.MainActivity.gpsFilter;
...
//    Service to access and store GPS data for recording, to give locations of comfort.
    ...
    public static List<String> gpsData = new ArrayList<>();
    long gpsSample;
    ...
    public static boolean autoStopOn, wifiCheckOn, timerOn_Slow, atHospital;
    double lat, lon;
...
//    Check for vehicle movement. High radial accuracy tends to imply the device is in a building.
    ...
    public void compareCoordinates() {
        if (BuildConfig.TEST_MODE || atHospital) {
    ...
    public static class JSONCoords {
        // Simple class to enable hospital coordinates to be read easily to arrays
